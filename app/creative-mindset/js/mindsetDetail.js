angular.module('cookbook').controller('mindsetDetailController',  function($scope, $http,$routeParams,commonService) {
  ...
  // 
    ...
    $http.get('/drupal/rest/node/'+$routeParams.cardUid).success(function(data)
    {
        ...
        if($scope.card.field_arsenal_files)
        {
